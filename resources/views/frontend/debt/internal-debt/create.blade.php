...
<div class="form-wrapper_container">
    <div class="form-wrapper">
        <h1 class="title">Create Internal Debt</h1>
        <p class="subtitle">Add a new internal debt record with its details.</p>
        <form class="contact-form" method="post" action="{{ route('internal.debt.store') }}">
            @csrf
            <div class="form-row">
