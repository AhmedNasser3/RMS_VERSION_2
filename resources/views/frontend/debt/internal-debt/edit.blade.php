...
<div class="form-wrapper_container">
    <div class="form-wrapper">
        <h1 class="title">Edit Internal Debt</h1>
        <p class="subtitle">Modify the details of this internal debt record.</p>
        <form class="contact-form" method="post" action="{{ route('internal.debt.update', $debt->id) }}">
            @csrf
            @method('PUT')
            <div class="form-row">
